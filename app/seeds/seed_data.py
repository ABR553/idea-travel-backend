...
def _seed_products(project_id: uuid.UUID) -> list[Product]:
    ...
    #  name_es, desc_es, name_en, desc_en, extra_images)
    data = [
        ("maleta-samsonite-spinner-55", "luggage", 129.99, "https://www.amazon.es/dp/B07EXAMPLE1?tag=ideatravel-21", "https://images.unsplash.com/photo-1565026057447-bc90a3dceb87?w=800", 4.7, "B07EXAMPLE1",
         ...
         ["https://images.unsplash.com/photo-1581553673739-c4906b5d0de8?w=800", "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800"]),
        ...
        ("powerbank-anker-20000", "electronics", 39.99, "https://www.amazon.es/dp/B07EXAMPLE4?tag=ideatravel-21", "https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800", 4.8, "B07EXAMPLE4",
         ...
         ["https://images.unsplash.com/photo-1625465588028-458f59e19ee6?w=800", "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=800"]),
        ("auriculares-sony-wh1000xm5", "electronics", 329.99, "https://www.amazon.es/dp/B07EXAMPLE5?tag=ideatravel-21", "https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?w=800", 4.8, "B07EXAMPLE5",
         ...
         ["https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=800", "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800"]),
        ...
        ("gopro-hero-12", "photography", 399.99, "https://www.amazon.es/dp/B07EXAMPLE8?tag=ideatravel-21", "https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=800", 4.7, "B07EXAMPLE8",
         ...
         ["https://images.unsplash.com/photo-1617575521317-d2974f3b56d2?w=800", "https://images.unsplash.com/photo-1532104041590-1046d1a28c64?w=800"]),
        ...
        ("mochila-cabina-40l", "luggage", 89.99, "https://www.amazon.es/dp/B07EXAMPLE12?tag=ideatravel-21", "https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=800", 4.6, "B07EXAMPLE12",
         ...
         ["https://images.unsplash.com/photo-1565026057447-bc90a3dceb87?w=800", "https://images.unsplash.com/photo-1581553673739-c4906b5d0de8?w=800"]),
    ]
    products = []
    for slug, cat, price, url, img, rating, ext_id, name_es, desc_es, name_en, desc_en, extra_imgs in data:
        pid = _id()
        products.append(Product(
            ...
            images=[
                ProductImage(id=_id(), product_id=pid, url=extra_url, position=i)
                for i, extra_url in enumerate(extra_imgs)
            ],
        ))
    return products
